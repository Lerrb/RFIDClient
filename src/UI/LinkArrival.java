...
public class LinkArrival extends JFrame {
    // 程序界面宽度
    ...
    private JLabel mpicknumber1 = new JLabel("取件编号");
    private JTextArea mpicknumbera1 = new JTextArea();
    private JLabel mstationaddress1 = new JLabel("物流站地址");
    private JTextArea mstationaddressa1 = new JTextArea();
    private JLabel mphonenumber1 = new JLabel("取件联系方式");
    private JTextArea mphonenumbera1 = new JTextArea();
...
//        mLinkPanel.add(mLink);
        ...
        mcardnumber1.setBounds(30, 60, 80, 40);
        ...
        mpicknumber1.setBounds(30, 120, 80, 40);
        mControlPanel.add(mpicknumber1);
        mpicknumbera1.setBounds(110, 120, 200, 40);
        mControlPanel.add(mpicknumbera1);

        mstationaddress1.setBounds(30, 180, 80, 40);
        mControlPanel.add(mstationaddress1);
        mstationaddressa1.setBounds(110, 180, 200, 40);
        mControlPanel.add(mstationaddressa1);

        mphonenumber1.setBounds(30, 240, 80, 40);
        mControlPanel.add(mphonenumber1);
        mphonenumbera1.setBounds(110, 240, 200, 40);
        mControlPanel.add(mphonenumbera1);

        mok.setBounds(80, 320, 200, 40);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI.LinkArrival().setVisible(true);
            }
        });
    }
}